...
const SkillsSchema = { // does this need fixing?
    Barbarian: ['Animal Handling', 'Athletics', 'Intimidation', 'Nature', 'Perception', 'Survival'],
    Bard: ['Acrobatics', 'Animal Handling', 'Arcana', 'Athletics', 'Deception', 'History', 'Insight', 'Intimidation', 'Investigation', 'Medicine', 'Nature', 'Perception', 'Performance', 'Persuasion', 'Sleight of Hand', 'Stealth', 'Survival'],
    Cleric: ['History', 'Insight', 'Medicine', 'Persuasion', 'Religion'],
    Druid: ['Animal Handling', 'Arcana', 'Athletics', 'Insight', 'Medicine', 'Nature', 'Perception', 'Survival'],
    Fighter: ['Acrobatics', 'Animal Handling', 'Athletics', 'History', 'Insight', 'Intimidation', 'Perception', 'Survival'],
    Monk: ['Acrobatics', 'Arcana', 'Athletics', 'History', 'Insight', 'Religion', 'Stealth'],
    Paladin: ['Athletics', 'Insight', 'Intimidation', 'Medicine', 'Persuasion', 'Religion'],
    Ranger: ['Animal Handling', 'Athletics', 'Insight', 'Investigation', 'Nature', 'Perception', 'Stealth', 'Survival'],
    Rogue: ['Acrobatics', 'Arcana', 'Athletics', 'Deception', 'Insight', 'Investigation', 'Medicine', 'Nature', 'Perception', 'Performance', 'Persuasion', 'Sleight of Hand', 'Stealth', 'Survival'],
    Sorcerer: ['Arcana', 'Deception', 'Insight', 'Intimidation', 'Persuasion', 'Religion'],
    Warlock: ['Arcana', 'Deception', 'History', 'Insight', 'Intimidation', 'Investigation', 'Nature', 'Religion'],
    Wizard: ['Arcana', 'History', 'Insight', 'Investigation', 'Medicine', 'Religion'],
    Artificer: ['Arcana', 'History', 'Insight', 'Investigation', 'Medicine', 'Perception']
  };
const CharacterSheetSchema = new mongoose.Schema(
	{
        ...
        inspiration: {
            ...
            required: [true, "Inspiration status must be specified"]
        },
        dexterity: {
			type: Number,
			default: 1
        ...
        personalityTraits: {
            ...
            minlength: 1,  // Minimum of 1 trait
            maxlength: 5   // Maximum of 5 traits  ??????
        },
        languages: {
        ...
        organizations: {
            ...
            required: [true, "Please provide the character's associated organization"],  // Ensures a value is provided
